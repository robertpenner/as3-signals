package org.osflash.signals.relaxed
{
	...
	public class RelaxedPrioritySignalTest
	{
		public function RelaxedPrioritySignalTest()
		{
		}
		private var _signal : RelaxedPrioritySignal; 
		
		[Before]
		public function setUp():void
		{
			_signal = new RelaxedPrioritySignal();
		}
		...
		public function testStrictPayload():void{
			...
			_signal= new RelaxedPrioritySignal( RelaxedSignalTestVO );
			_signal.dispatch( value );
			_signal.addOnce( handler );
			assertEquals( 'should match', value, passedPayload );
		}
