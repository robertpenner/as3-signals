package com.robertpenner.signals
{
	...
	public class Signal implements ISignal
	{
		 ...
		 * @param	eventClass Optional class reference.
		 * This enables a event type check in dispatch().
		 */
		...
		public function dispatch(eventObject:Object):void
		{
			...
			if (event)
			{
				...
				//TODO: test cloning in a scenario
				if (eventTarget)
				{
					eventObject = event = event.clone();
				}
				event.target = eventTarget || this.target;
